## The majority of this code was copypasted from https://godotengine.org/asset-library/asset/2762
## did not know there was a draw_rect() command before this tho
## also there was a strange... echo for the spectrogram whenever the song stopped?? that I had to fix
...
func _draw():
	var w = float(WIDTH) / float(VU_COUNT)
