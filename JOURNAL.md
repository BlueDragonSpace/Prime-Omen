...
<br> Annnnnddddd exported!!!! Only just now realized that I never really added a JOURNAL file and instead just put it all in the README, whoops...
<br> Anyway, I consider this project a success. There's a lot of audio-related stuff I could have wiki-dived into (there's a few stuff left in notes.txt for possible future to-dos), but I got the main things I wanted out of this project, so I'm happy with it.
